...
# Memperbaiki warning datetime adapter
...
def halaman_laporan():
    ...
    # KONVERSI KOLOM WAKTU KE DATETIME - Perbaikan ada di sini
    # Gunakan format='ISO8601' untuk menangani format ISO
    try:
    ...
    if filter_jenis == "Harian":
        ...
        minggu_ini = now.isocalendar()[1]  # Menggunakan indeks untuk kompatibilitas pandas versi lama
        tahun_ini = now.year
        filtered = riwayat_df[
